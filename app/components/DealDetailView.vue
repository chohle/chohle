    ...
    >
      <template #body>
        <form class="flex flex-col gap-4" @submit.prevent="send">
          <UFormField :label="$t('pipeline.detail.to')">
            <UInput v-model="composer.to" type="email" class="w-full" />
          </UFormField>
    ...
    <UModal v-model:open="reply.open" :title="$t('pipeline.detail.logReply')">
      <template #body>
        <div class="flex flex-col gap-3">
          <UFormField :label="$t('pipeline.detail.from')">
            <UInput v-model="reply.from" type="email" class="w-full" />
          </UFormField>
          <UFormField :label="$t('pipeline.detail.subject')">
