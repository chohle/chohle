...
setup. For the shared concepts (BATZE_SECRET, threading, what gets
...
locally. To revoke at Microsoft's side too, remove batze from
...
For non Outlook troubleshooting (BATZE_SECRET, threading not matching,
