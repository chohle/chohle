...
const STR = {
  en: {
    ...
    exp: {
      rentLuzern: 'Rent, Apartment Lucerne',
      migrosWeekly: 'Migros weekly shop',
      gaTravelcard: 'GA Travelcard',
      lunchClient: 'Lunch with client',
      adobe: 'Adobe Creative Cloud',
      coopGroceries: 'Coop groceries',
      ...
      officeChair: 'Office chair (new)',
      groceries: 'Groceries',
      trainTickets: 'Train tickets',
      softwareSubs: 'Software subscriptions',
      dentist: 'Dentist'
    },
    proj: {
      webshop: {
      ...
      legacyHeating: {
        name: 'Heating control (maintenance)',
        label: 'One off maintenance visit',
        notes: 'Old job. Closed.'
      },
      quickConsulting: {
        name: 'Digitalization coaching',
    ...
    inv: {
      t101: 'Heating control maintenance',
      t001: 'Maintenance contract 2026 (Q1)',
      t002: 'Website relaunch (phase 1)',
      t003: 'Website relaunch (phase 2)',
      t004: 'Website relaunch (phase 3)',
      t099: 'Website audit + report',
      t005: 'Digitalization consulting'
    },
    quo: {
      q1: 'Marketing site relaunch',
      q2: 'Follow-up digitalization consulting',
      q3: 'Branding refresh',
      q4: 'IT audit Q4',
      q0: 'Website relaunch (quote)'
    },
    desc: {
      maintenanceWork: 'Maintenance work',
      travel: 'Travel',
      travels: 'Travel',
      maintQ1: 'Maintenance January to March',
      conceptDesign: 'Concept and design',
      stakeholderWorkshops: 'Stakeholder workshops',
      implSprint1: 'Implementation sprint 1',
      reviewsIterations: 'Reviews and iterations',
      implSprint2: 'Implementation sprint 2',
      auditReport: 'Audit, report and recommendations',
      toolLicenses: 'Tool licenses',
      consulting: 'Consulting',
      conceptWireframes: 'Concept, wireframes, design system',
      workshopSupport: 'Workshop and support',
  ...
  de: {
    ...
    art: {
      ...
      hosting: 'Hosting',
      expenses: 'Spesen',
      retainer: 'Retainer Betreuung',
      express: 'Express-Zuschlag',
      cleaning: 'Reinigung Baustelle'
    },
    job: { swEngineer: 'Software Engineer', uxConsulting: 'UX-Beratung' },
    exp: {
      rentLuzern: 'Miete, Wohnung Luzern',
      migrosWeekly: 'Wocheneinkauf Migros',
      gaTravelcard: 'Generalabonnement',
      lunchClient: 'Mittagessen mit Kunde',
      adobe: 'Adobe Creative Cloud',
      coopGroceries: 'Lebensmittel Coop',
      electricity: 'Strom',
      physio: 'Physiotherapie',
      dinnerOut: 'Abendessen auswärts',
      petrol: 'Benzin',
      mobilePlan: 'Mobilabo',
      githubTeam: 'GitHub Team',
      officeChair: 'Bürostuhl (neu)',
      groceries: 'Lebensmittel',
      trainTickets: 'Bahntickets',
      softwareSubs: 'Software-Abos',
      dentist: 'Zahnarzt'
    },
    proj: {
      webshop: {
        name: 'Webshop-Redesign',
        label: 'Neuer Shop mit Checkout',
        notes: 'Erstes Gespräch vielversprechend. Will Mockups bis Monatsende.'
      },
      logoCi: { name: 'Logo & CI', label: 'Persönliche Markenidentität', notes: '' },
      booking: {
        name: 'Restaurant-Reservationssystem',
        label: 'OpenTable-Integration',
        notes: 'Referenzprojekte gesendet.'
      },
      marketing: {
        name: 'Marketing-Website',
        label: 'Statische Landingpage + CMS',
        notes: 'Offerte gesendet, warten auf Antwort.'
      },
      maintContract: {
        name: 'Wartungsvertrag 2026',
        label: 'Jährlicher Wartungsvertrag',
        notes: 'Gewonnen! Jährliche Wartung.'
      },
      relaunch: {
        name: 'Website-Relaunch',
        label: 'Komplettes Redesign + Migration',
        notes: 'In Umsetzung. Phase 1 verrechnet.'
      },
      consultingQ1: {
        name: 'Beratung Q1',
        label: 'Retainer 20 Std./Monat',
        notes: 'Aktiver Retainer.'
      },
      audit: {
        name: 'Website-Audit',
        label: 'Einmaliges Audit + Bericht',
        notes: 'Erledigt. Verrechnet und bezahlt.'
      },
      laptops: {
        name: 'Team-Laptops',
        label: '3 neue MacBooks benötigt',
        notes: 'Aktuelle Laptops werden alt.'
      },
      cleaningQuotes: {
        name: 'Offerten Reinigungsdienst',
        label: 'Wöchentliche Büroreinigung',
        notes: 'Anfrage an 3 Anbieter gesendet.'
      },
      hostingCompare: {
        name: 'Server-Hosting-Vergleich',
        label: 'VPS in der EU',
        notes: '3 Offerten erhalten. In Prüfung.'
      },
      furniture: {
        name: 'Büromöbel',
        label: 'Stehpulte + Stühle',
        notes: 'Bestellung bei Pfister aufgegeben.'
      },
      legacyHeating: {
        name: 'Heizungssteuerung (Wartung)',
        label: 'Einmaliger Wartungsbesuch',
        notes: 'Alter Auftrag. Abgeschlossen.'
      },
      quickConsulting: {
        name: 'Digitalisierung Coaching',
        label: 'Einmalige Coaching-Session',
        notes: 'Einfach die Stunden verrechnen.'
      }
    },
    email: {
      ...
      text2:
        'Hallo, danke. Wir haben das intern besprochen und möchten loslegen. Können wir nächste Woche einen Kickoff-Call vereinbaren?\n\nThomas'
    },
    inv: {
      t101: 'Wartung Heizungssteuerung',
      t001: 'Wartungsvertrag 2026 (Q1)',
      t002: 'Website-Relaunch (Phase 1)',
      t003: 'Website-Relaunch (Phase 2)',
      t004: 'Website-Relaunch (Phase 3)',
      t099: 'Website-Audit + Bericht',
      t005: 'Beratung Digitalisierung'
    },
    quo: {
      q1: 'Marketing-Website Relaunch',
      q2: 'Folge-Beratung Digitalisierung',
      q3: 'Branding-Auffrischung',
      q4: 'IT-Audit Q4',
      q0: 'Website-Relaunch (Angebot)'
    },
    desc: {
      maintenanceWork: 'Wartungsarbeiten',
      travel: 'Anfahrt',
      travels: 'Anfahrten',
      maintQ1: 'Wartung Januar bis März',
      conceptDesign: 'Konzept und Design',
      stakeholderWorkshops: 'Stakeholder-Workshops',
      implSprint1: 'Umsetzung Sprint 1',
      reviewsIterations: 'Reviews und Iterationen',
      implSprint2: 'Umsetzung Sprint 2',
      auditReport: 'Audit, Bericht und Empfehlungen',
      toolLicenses: 'Tool-Lizenzen',
      consulting: 'Beratung',
      conceptWireframes: 'Konzept, Wireframes, Designsystem',
      workshopSupport: 'Workshop und Begleitung',
      logoVariations: 'Logo-Variationen',
  ...
  fr: {
    ...
    art: {
      ...
      hosting: 'Hébergement',
      expenses: 'Frais',
      retainer: 'Forfait de suivi',
      express: 'Supplément express',
      cleaning: 'Nettoyage de chantier'
    },
    job: { swEngineer: 'Ingénieur logiciel', uxConsulting: 'Conseil UX' },
    exp: {
      rentLuzern: 'Loyer, appartement Lucerne',
      migrosWeekly: 'Courses hebdo Migros',
      gaTravelcard: 'Abonnement général',
      lunchClient: 'Déjeuner avec client',
      adobe: 'Adobe Creative Cloud',
      coopGroceries: 'Courses Coop',
      electricity: 'Électricité',
      physio: 'Physiothérapie',
      dinnerOut: 'Dîner au restaurant',
      petrol: 'Essence',
      mobilePlan: 'Abonnement mobile',
      githubTeam: 'GitHub Team',
      officeChair: 'Chaise de bureau (neuve)',
      groceries: 'Alimentation',
      trainTickets: 'Billets de train',
      softwareSubs: 'Abonnements logiciels',
      dentist: 'Dentiste'
    },
    proj: {
      webshop: {
        name: 'Refonte de la boutique en ligne',
        label: 'Nouvelle boutique avec paiement',
        notes: 'Premier appel prometteur. Souhaite des maquettes d’ici la fin du mois.'
      },
      logoCi: { name: 'Logo & CI', label: 'Identité de marque personnelle', notes: '' },
      booking: {
        name: 'Système de réservation restaurant',
        label: 'Intégration OpenTable',
        notes: 'Projets de référence envoyés.'
      },
      marketing: {
        name: 'Site marketing',
        label: 'Landing statique + CMS',
        notes: 'Offre envoyée, en attente de réponse.'
      },
      maintContract: {
        name: 'Contrat de maintenance 2026',
        label: 'Contrat de maintenance annuel',
        notes: 'Gagné ! Maintenance annuelle.'
      },
      relaunch: {
        name: 'Refonte du site web',
        label: 'Refonte complète + migration',
        notes: 'En production. Phase 1 facturée.'
      },
      consultingQ1: { name: 'Conseil T1', label: 'Forfait 20 h/mois', notes: 'Forfait actif.' },
      audit: {
        name: 'Audit du site web',
        label: 'Audit ponctuel + rapport',
        notes: 'Terminé. Facturé et payé.'
      },
      laptops: {
        name: 'Ordinateurs portables de l’équipe',
        label: 'Besoin de 3 nouveaux MacBooks',
        notes: 'Les portables actuels vieillissent.'
      },
      cleaningQuotes: {
        name: 'Offres service de nettoyage',
        label: 'Nettoyage hebdomadaire des bureaux',
        notes: 'Demande envoyée à 3 fournisseurs.'
      },
      hostingCompare: {
        name: 'Comparatif d’hébergement serveur',
        label: 'VPS basé en UE',
        notes: '3 offres reçues. En évaluation.'
      },
      furniture: {
        name: 'Mobilier de bureau',
        label: 'Bureaux assis-debout + chaises',
        notes: 'Commande passée chez Pfister.'
      },
      legacyHeating: {
        name: 'Régulation du chauffage (maintenance)',
        label: 'Visite de maintenance ponctuelle',
        notes: 'Ancien mandat. Clôturé.'
      },
      quickConsulting: {
        name: 'Coaching digitalisation',
        label: 'Séance de coaching ponctuelle',
        notes: 'Facturer simplement les heures.'
      }
    },
    email: {
      ...
      text2:
        'Bonjour, merci. Nous en avons discuté en interne et souhaitons avancer. Pouvons-nous fixer un appel de lancement la semaine prochaine ?\n\nThomas'
    },
    inv: {
      t101: 'Maintenance régulation chauffage',
      t001: 'Contrat de maintenance 2026 (T1)',
      t002: 'Refonte du site web (phase 1)',
      t003: 'Refonte du site web (phase 2)',
      t004: 'Refonte du site web (phase 3)',
      t099: 'Audit du site web + rapport',
      t005: 'Conseil en digitalisation'
    },
    quo: {
      q1: 'Refonte du site marketing',
      q2: 'Conseil digitalisation – suivi',
      q3: 'Rafraîchissement de l’image de marque',
      q4: 'Audit IT T4',
      q0: 'Refonte du site web (offre)'
    },
    desc: {
      maintenanceWork: 'Travaux de maintenance',
      travel: 'Déplacement',
      travels: 'Déplacements',
      maintQ1: 'Maintenance de janvier à mars',
      conceptDesign: 'Concept et design',
      stakeholderWorkshops: 'Ateliers avec les parties prenantes',
      implSprint1: 'Sprint de mise en œuvre 1',
      reviewsIterations: 'Revues et itérations',
      implSprint2: 'Sprint de mise en œuvre 2',
      auditReport: 'Audit, rapport et recommandations',
      toolLicenses: 'Licences d’outils',
      consulting: 'Conseil',
      conceptWireframes: 'Concept, wireframes, design system',
      workshopSupport: 'Atelier et accompagnement',
      logoVariations: 'Variations de logo',
  ...
  it: {
    ...
    art: {
      ...
      maintenance: 'Lavori di manutenzione',
      webdesign: 'Web design',
      hosting: 'Hosting',
      expenses: 'Spese',
      retainer: 'Servizio in abbonamento',
      express: 'Supplemento express',
      cleaning: 'Pulizia cantiere'
    },
    job: { swEngineer: 'Ingegnere del software', uxConsulting: 'Consulenza UX' },
    exp: {
      rentLuzern: 'Affitto, appartamento Lucerna',
      migrosWeekly: 'Spesa settimanale Migros',
      gaTravelcard: 'Abbonamento generale',
      lunchClient: 'Pranzo con cliente',
      adobe: 'Adobe Creative Cloud',
      coopGroceries: 'Spesa Coop',
      electricity: 'Elettricità',
      physio: 'Fisioterapia',
      dinnerOut: 'Cena fuori',
      petrol: 'Benzina',
      mobilePlan: 'Abbonamento mobile',
      githubTeam: 'GitHub Team',
      officeChair: 'Sedia da ufficio (nuova)',
      groceries: 'Spesa',
      trainTickets: 'Biglietti del treno',
      softwareSubs: 'Abbonamenti software',
      dentist: 'Dentista'
    },
    proj: {
      webshop: {
        name: 'Restyling del webshop',
        label: 'Nuovo negozio con checkout',
        notes: 'Primo contatto promettente. Vuole i mockup entro fine mese.'
      },
      logoCi: { name: 'Logo & CI', label: 'Identità di marca personale', notes: '' },
      booking: {
        name: 'Sistema di prenotazione ristorante',
        label: 'Integrazione OpenTable',
        notes: 'Inviati progetti di riferimento.'
      },
      marketing: {
        name: 'Sito marketing',
        label: 'Landing statica + CMS',
        notes: 'Offerta inviata, in attesa di risposta.'
      },
      maintContract: {
        name: 'Contratto di manutenzione 2026',
        label: 'Contratto di manutenzione annuale',
        notes: 'Vinto! Manutenzione annuale.'
      },
      relaunch: {
        name: 'Rilancio del sito web',
        label: 'Restyling completo + migrazione',
        notes: 'In produzione. Fase 1 fatturata.'
      },
      consultingQ1: {
        name: 'Consulenza T1',
        label: 'Abbonamento 20 h/mese',
        notes: 'Abbonamento attivo.'
      },
      audit: {
        name: 'Audit del sito web',
        label: 'Audit una tantum + report',
        notes: 'Completato. Fatturato e pagato.'
      },
      laptops: {
        name: 'Laptop per il team',
        label: 'Servono 3 nuovi MacBook',
        notes: 'I laptop attuali stanno invecchiando.'
      },
      cleaningQuotes: {
        name: 'Offerte servizio di pulizia',
        label: 'Pulizia settimanale dell’ufficio',
        notes: 'Richiesta inviata a 3 fornitori.'
      },
      hostingCompare: {
        name: 'Confronto hosting server',
        label: 'VPS con sede in UE',
        notes: 'Ricevute 3 offerte. In valutazione.'
      },
      furniture: {
        name: 'Mobili per ufficio',
        label: 'Scrivanie regolabili + sedie',
        notes: 'Ordine effettuato da Pfister.'
      },
      legacyHeating: {
        name: 'Regolazione riscaldamento (manutenzione)',
        label: 'Intervento di manutenzione una tantum',
        notes: 'Vecchio incarico. Chiuso.'
      },
      quickConsulting: {
        name: 'Coaching digitalizzazione',
        label: 'Sessione di coaching una tantum',
        notes: 'Fatturare semplicemente le ore.'
      }
    },
    email: {
      ...
      text2:
        'Salve, grazie. Ne abbiamo parlato internamente e vogliamo procedere. Possiamo fissare una call di kickoff la prossima settimana?\n\nThomas'
    },
    inv: {
      t101: 'Manutenzione regolazione riscaldamento',
      t001: 'Contratto di manutenzione 2026 (T1)',
      t002: 'Rilancio del sito web (fase 1)',
      t003: 'Rilancio del sito web (fase 2)',
      t004: 'Rilancio del sito web (fase 3)',
      t099: 'Audit del sito web + report',
      t005: 'Consulenza digitalizzazione'
    },
    quo: {
      q1: 'Rilancio del sito marketing',
      q2: 'Consulenza digitalizzazione – follow-up',
      q3: 'Rinfresco del branding',
      q4: 'Audit IT T4',
      q0: 'Rilancio del sito web (offerta)'
    },
    desc: {
      maintenanceWork: 'Lavori di manutenzione',
      travel: 'Trasferta',
      travels: 'Trasferte',
      maintQ1: 'Manutenzione da gennaio a marzo',
      conceptDesign: 'Concept e design',
      stakeholderWorkshops: 'Workshop con gli stakeholder',
      implSprint1: 'Sprint di implementazione 1',
      reviewsIterations: 'Revisioni e iterazioni',
      implSprint2: 'Sprint di implementazione 2',
      auditReport: 'Audit, report e raccomandazioni',
      toolLicenses: 'Licenze software',
      consulting: 'Consulenza',
      conceptWireframes: 'Concept, wireframe, design system',
      workshopSupport: 'Workshop e accompagnamento',
      logoVariations: 'Varianti del logo',
...
export function seedDemo(db: Database, requested: string): SeedResult {
  ...
  for (const [key, type, color, icon] of categories) {
    cat[key] = insertCategory.run(
      S.cat[key as keyof typeof S.cat],
      type,
      color,
      icon
    ).lastInsertRowid
  ...
  for (const [m, d, titleKey, amount, c, vendor] of expenses) {
    insertExpense.run(
      S.exp[titleKey as keyof typeof S.exp],
      chf(amount),
      day(m, d),
      cat[c],
      vendor,
  ...
  addInvoice(muellerId, legacyHeatingId, '2025-101', S.inv.t101, 'paid', 5, [
    {
      article: art.maintenance,
      desc: S.desc.maintenanceWork,
      qty: 8,
      unit: S.units.hours,
      price: 120
    },
  ...
  addInvoice(studioId, activeProjectId, '2026-002', S.inv.t002, 'paid', 1, [
    ...
    {
      article: art.consulting,
      desc: S.desc.stakeholderWorkshops,
      qty: 8,
      unit: S.units.hours,
      price: 150
    }
  ...
  // no Convert button.
  const phase1InvoiceId = (
    db.prepare("SELECT id FROM invoices WHERE number = '2026-002'").get() as { id: number }
  ).id
  addQuote(
    studioId,
    activeProjectId,
